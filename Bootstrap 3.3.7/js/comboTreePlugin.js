...
; (function ($, window, document, undefined) {
    ...
    ComboTree.prototype.init = function () {
        ...
        this._elemArrowBtn = $('<span id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn comboTreeArrowBtnImg">▼</span>');
        this._elemInput.after(this._elemArrowBtn);
        this._elemWrapper.append('<div id="' + this.comboTreeId + 'DropDownContainer" class="comboTreeDropDownContainer" style="z-index:999"><div class="comboTreeDropDownContent"></div>');
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle"><input type="checkbox" id="'+sourceItem.checkboxid+sourceItem.id+'" name="' + sourceItem.name + '" value="' + sourceItem.id + '">' + sourceItem.title + '</span>';
        else
